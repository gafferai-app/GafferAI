  ...
  return (
    <>
      ...
      <div className="footer">
        ...
        {/* Footer */}
        <div style={{borderTop:"1px solid rgba(255,255,255,0.06)",padding:"24px 20px",textAlign:"center",marginTop:40}}>
          <div style={{display:"flex",gap:16,justifyContent:"center",flexWrap:"wrap",fontSize:12,color:"#475569"}}>
            <span style={{cursor:"pointer",color:"#64748b"}} onClick={()=>setShowLegal("terms")}>Terms & Conditions</span>
            <span style={{color:"#334155"}}>·</span>
            <span style={{cursor:"pointer",color:"#64748b"}} onClick={()=>setShowLegal("privacy")}>Privacy Policy</span>
            <span style={{color:"#334155"}}>·</span>
            <span style={{cursor:"pointer",color:"#64748b"}} onClick={()=>setShowLegal("contact")}>Contact Us</span>
            <span style={{color:"#334155"}}>·</span>
            <span style={{color:"#334155"}}>GafferAI · Built in Scotland</span>
          </div>
        </div>
      </div>
    </>
  ...
  const css = `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    @media(max-width:480px){
      /* Nav */
      .nav{padding:0 12px;height:56px;flex-wrap:wrap;gap:6px}
