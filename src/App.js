        ...
        <div key={i}
          ...
          {p.name && (
            <div style={{
              ...
              whiteSpace:"nowrap", maxWidth: isMobile ? 55 : 70,
    ...
    <div>
      ...
      {playerPositions.length > 0 && (
        <div style={{ background:"#16202b", border:"1px solid rgba(255,255,255,0.08)", borderRadius:12, padding:16 }}>
          <div style={{ fontSize:11, fontWeight:700, color:"#34d399", letterSpacing:"1px", textTransform:"uppercase", marginBottom:10 }}>👥 Player Names</div>
          <div style={{ display:"flex", flexDirection:"column", gap:6, maxHeight:isMobile?220:300, overflowY:"auto" }}>
            {playerPositions.map((p,i)=>(
              <div key={i} style={{ display:"flex", alignItems:"center", gap:8 }}>
                <span style={{ fontSize:10, fontWeight:700, color:"#34d399", width:36, flexShrink:0, fontFamily:"'Barlow Condensed',sans-serif", letterSpacing:1, textTransform:"uppercase" }}>{p.pos}</span>
                <input
                  value={p.name||""}
