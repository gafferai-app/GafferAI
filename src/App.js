...
function SCProgramme({ userId, showToast, goHome, profile, setProfile, loadHistory }) {
    ...
    <>
      ...
      <div className="app">
        ...
        <div className="page-wrap" style={{maxWidth:1100,margin:"0 auto",padding:"0 20px 60px"}}>
          ...
          {screen==="tool"&&activeTool?.id==="sc"        &&<SCProgramme  userId={user.id} showToast={showToast} goHome={goHome} profile={profile} setProfile={setProfile} loadHistory={loadHistory}/>}
