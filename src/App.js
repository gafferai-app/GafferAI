  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <div className="stats">
          {[["40k+","UK clubs"],["8","AI tools"],["30s","per generation"],["£4.99","/month"]].map(([v,l]) => (
        ...
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          ...
          <div className="pricing-grid">
            ...
            <div className="price-card">
              ...
              {["10 AI generations","Valid for 7 days","All 8 tools including S&C 🏋️"].map(f => (
                <div key={f} style={{fontSize:14,color:"#94a3b8",padding:"6px 0",borderBottom:"1px solid rgba(255,255,255,0.06)"}}>✓ {f}</div>
              ))}
...
function ProNudgeModal({ onClose, onUpgrade, loading }) {
  return (
