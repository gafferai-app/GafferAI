              ...
              {resetSent ? (
                ...
                <div>
                  <div style={{ textAlign:"center", marginBottom:20 }}>
                    ...
                    <div style={{ fontSize:14, color:"#94a3b8" }}>We sent a 6-digit code to</div>
                    <div style={{ fontSize:14, fontWeight:700, color:"#4ade80", marginTop:4 }}>{email}</div>
                  </div>
                  <div style={{ marginBottom:14 }}>
                    <label style={{ display:"block", fontSize:11, fontWeight:700, color:"#94a3b8", letterSpacing:"1.2px", textTransform:"uppercase", marginBottom:6 }}>🔢 Enter 6-Digit Code</label>
