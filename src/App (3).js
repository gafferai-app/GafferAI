              ...
              {resetSent ? (
                ...
                <div>
                  <div style={{ textAlign:"center", marginBottom:20 }}>
                    ...
                    <div style={{ fontSize:14, color:"#94a3b8" }}>We sent a reset code to</div>
                    <div style={{ fontSize:14, fontWeight:700, color:"#4ade80", marginTop:4 }}>{email}</div>
                  </div>
                  <div style={{ marginBottom:14 }}>
                    <label style={{ display:"block", fontSize:11, fontWeight:700, color:"#94a3b8", letterSpacing:"1.2px", textTransform:"uppercase", marginBottom:6 }}>🔢 Enter Your Reset Code</label>
                ...
                <div>
                  <div style={{ fontSize:13, color:"#64748b", marginBottom:16 }}>Enter your email and we will send you a 6-digit code.</div>
